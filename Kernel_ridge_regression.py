...
# FD. save_results()
def save_results(kernel_name, eigenval, percentages, r2_test, r2_train):
    """Saves computed results into CSV files."""
    csv_path = f'./tem_results/{kernel_name}'
...
def kernel_ridge_regression(data:pd.DataFrame, kernel_name:str, n_train: int = 5000, n_test: int = 10000, mol_property: str = 'Gap', representation: str = 'BOB', regularization: bool = False):
    ...
    # Save results
    save_results(kernel_name, eigenval, percentages, r2_test, r2_train)
...
if __name__ == "__main__":
    ...
    kernel_ridge_regression(data, kernel_name='gaussian', mol_property='Gap', representation='BOB', regularization=False)
